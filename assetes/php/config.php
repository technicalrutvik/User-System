...
class Database{
	const USERNAME='rutvikghori25@gmail.com';
	const PASSWORD='useforsocial';
	...
	//Display time in ago
	public function timeInAgo($timestmap){
		date_default_timezone_set('Asia/Kolkata');

		$timestmap = strtotime($timestmap) ? strtotime($timestmap) : $timestmap;
